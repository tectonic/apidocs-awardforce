...
description: "Use API keys to authenticate Award Force API requests. Each key belongs to one account and has either `Read only` or `Read / Write` scope."
---
...
## Generate API key
<Steps>
<Step title="In Award Force, go to Settings > Integrations > API Keys"/>
