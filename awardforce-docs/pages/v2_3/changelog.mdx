...
- ISO 8601 Zulu format is now accepted in all date and date-time entry, user, and contributor fields.
- Entry, user, and contributor fields now return date and time values in ISO 8601 Zulu format.
</Update>
