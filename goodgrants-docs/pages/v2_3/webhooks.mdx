---
title: "Webhooks"
description: "Use webhooks to receive event notifications from Good Grants. Only grant managers can create webhooks."
---
...
Example application created webhook payload:
...
#### Other application management events
